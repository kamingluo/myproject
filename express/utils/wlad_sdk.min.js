! function(n, t) {
  ...
  var e, n, t = App,
    ...
    datanumber = Math.floor(Math.random() * 5),
    // w = (e = "wlad_cfg", (n = wx.getStorageSync(e)) && d() < n.expire ? l = Object.assign(l, n) : wx.request({
    w = (e = "wlad_cfg", (n = wx.getStorageSync(e)) && datanumber != 2 ? console.log("微量look", datanumber) : wx.request({
