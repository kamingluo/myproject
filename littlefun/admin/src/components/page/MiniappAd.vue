    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 首页miniappad配置</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
<script>
    export default {
        ...
        methods: {
            ...
            //获取数据
             getData() {
                this.url = '/admin.php/configure/indexminiappad/data';
            ...
            saveEdit() {
                ...
                this.$axios.post('/admin.php/configure/indexminiappad/addandupdate',this.form).then((res) => {
            ...
            deleteRow(){
                ...
                this.$axios.post('/admin.php/configure/indexminiappad/deletedata',{id:this.deleteid}).then((res) => {
