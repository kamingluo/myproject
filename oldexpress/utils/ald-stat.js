! function(n, t) {
  ...
  function e() {
    "function" == typeof dn && "" === G && dn().then(function(n) {
  ...
  function i(n) {
    e();
    var t;
    t = n.scene != ln, ln = n.scene, V = 0, W = n, F = n.query.ald_share_src, X = n.query.aldsrc || "", Y = n.query.ald_share_src, fn || ($ = !1), fn = !1, hn || (0 !== Q && Date.now() - Q > 3e4 ? (T = S(), N = Date.now()) : t && (N = Date.now(), T = S())), 0 !== Q && Date.now() - Q < 3e4 && (rn = !0), n.query.ald_share_src && "1044" == n.scene && n.shareTicket ? wx.getShareInfo({
      shareTicket: n.shareTicket,
      success: function(n) {
        nn = n, D("event", "ald_share_click", JSON.stringify(n))
      }
    }) : n.query.ald_share_src && D("event", "ald_share_click", 1), "" === tn && wx.getSetting({
      withCredentials: !0,
      success: function(n) {
        if (n.authSetting["scope.userInfo"]) {
          wx.getUserInfo({
            ...
            success: function(n) {
              var t = v();
              tn = n, t.ufo = _(n), K = y(n.userInfo.avatarUrl.split("/")), w(t)
            }
          })
        }
      }
  ...
  function c() {
    sn = B ? this.$mp.page.route : this.route, A("page", "show"), rn = !1
  }
  ...
  function q(n, t) {
    var e = v();
    e.ev = n, e.life = t, e.ec = Z, e.dr = Date.now() - N, X && (e.qr = X, e.sr = X), F && (e.usr = F), w(e)
  }

  function A(n, t) {
    var e = v();
    e.ev = n, e.life = t, e.pp = sn, e.pc = an, e.dr = Date.now() - N, hn && (e.so = 1), hn = !1, un && "{}" != JSON.stringify(un) && (e.ag = un), X && (e.qr = X, e.sr = X), F && (e.usr = F), rn && (e.ps = 1), on || (cn = sn, on = !0, e.ifp = on, e.fp = sn), w(e)
  }

  function D(n, t, e) {
    var o = v();
    o.ev = n, o.tp = t, o.dr = Date.now() - N, e && (o.ct = e), w(o)
  }
  ...
  try {
    ...
    en.br = gn.brand, en.pm = gn.model, en.pr = gn.pixelRatio, en.ww = gn.windowWidth, en.wh = gn.windowHeight, en.lang = gn.language, en.wv = gn.version, en.wvv = gn.platform, en.wsdk = gn.SDKVersion, en.sv = gn.system
  } catch (n) {}
  wx.getNetworkType({
    success: function(n) {
      en.nt = n.networkType
    ...
    t.tp = "session", t.ct = "session", t.ev = "event", "" === tn ? wx.getSetting({
      success: function(n) {
        n.authSetting["scope.userInfo"] ? wx.getUserInfo({
          success: function(n) {
            t.ufo = _(n), K = y(n.userInfo.avatarUrl.split("/")), "" !== nn && (t.gid = nn), w(t)
          }
        }) : "" !== nn && (t.gid = nn, w(t))
      }
    }) : (t.ufo = tn, "" !== nn && (t.gid = nn), w(t))
    ...
    var t = v();
    t.tp = "openid", t.ev = "event", t.ct = "openid", w(t)
  }, o.prototype.setOpenid = function(n) {
    "function" == typeof n && (dn = n, e())
  };
  return H.plugin ? {
    App: L,
    Page: O,
